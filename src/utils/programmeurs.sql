...
INSERT INTO PROGRAMMEUR (NOM, PRENOM, ADRESSE, PSEUDO, RESPONSABLE, HOBBY, ANNAISSANCE, SALAIRE, PRIME)
VALUES
...
SELECT * FROM PROGRAMMEUR WHERE ID = 5; #test de selection

DELETE FROM PROGRAMMEUR WHERE ID = 5; #test de suppression
